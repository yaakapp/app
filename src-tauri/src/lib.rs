...
use crate::plugin::{
    find_plugins, get_plugin, ImportResult, PluginCapability, run_plugin_export_curl,
    run_plugin_filter, run_plugin_import,
};
...
async fn cmd_filter_response(
    ...
    run_plugin_filter(&body, filter, plugin_name).await
}
