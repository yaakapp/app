...
` && ++r, b = r;
        ...
        function Fe() {
          var e, t, u, l;
          return i = null, A(), e = r, t = Ie(), u = ge(), l = Ee(t.value, u.value), f.tokenize ? {
        ...
        function N() {
          var e;
          return e = i, r = e.end, g = e.lineNumber, b = e.lineStart, i = typeof f.tokens < "u" ? Pe() : we(), r = e.end, g = e.lineNumber, b = e.lineStart, e;
        }
        function _e() {
          var e, t, u;
          e = r, t = g, u = b, i = typeof f.tokens < "u" ? Pe() : we(), r = e, g = t, b = u;
        }
        function Le(e, t) {
        ...
        function Te(e, t) {
          var u, l, C;
          return u = c, C = i, l = Ne(), t && c && J(e[0].name) && G(t, a.StrictParamName), c = u, n.markEnd(n.createFunctionExpression(null, e, [], l), C);
        }
        function De() {
          var e, t;
        ...
        function et() {
          ...
          if (e = i, x = i, e.type === y.Identifier)
            return u = De(), e.value === "get" && !_(":") ? (t = De(), O("("), O(")"), l = Te([]), n.markEnd(n.createProperty("get", t, l), x)) : e.value === "set" && !_(":") ? (t = De(), O("("), e = i, e.type !== y.Identifier ? (O(")"), G(e, a.UnexpectedToken, e.value), l = Te([])) : (C = [ye()], O(")"), l = Te(C, e)), n.markEnd(n.createProperty("set", t, l), x)) : (O(":"), l = le(), n.markEnd(n.createProperty("init", u, l), x));
        ...
        function Re() {
          ...
          if (e = i.type, l = i, e === y.Identifier)
            ...
            e === y.BooleanLiteral ? (t = N(), t.value = t.value === "true", u = n.createLiteral(t)) : e === y.NullLiteral ? (t = N(), t.value = null, u = n.createLiteral(t)) : _("/") || _("/=") ? (typeof f.tokens < "u" ? u = n.createLiteral(de()) : u = n.createLiteral(Fe()), _e()) : pe(N());
        ...
        function ct() {
          var e;
          return Z("var"), e = Oe(), he(), n.createVariableDeclaration(e, "var");
        }
        function ft(e) {
          var t, u;
          return u = i, Z(e), t = Oe(e), he(), n.markEnd(n.createVariableDeclaration(t, e), u);
        }
        function pt() {
        ...
        function Et() {
          var e, t, u;
          return u = i, e = N(), t = Oe(), n.markEnd(n.createVariableDeclaration(t, e.value), u);
        }
        function At() {
          var e, t, u, l, C, x, j;
        ...
        function Ge() {
          var e, t = [], u, l, C, x, j, W, ue, re;
          return re = i, Z("function"), l = i, e = ye(), c ? J(l.value) && G(l, a.StrictFunctionName) : J(l.value) ? (j = l, W = a.StrictFunctionName) : Y(l.value) && (j = l, W = a.StrictReservedWord), x = qe(j), t = x.params, C = x.stricted, j = x.firstRestricted, x.message && (W = x.message), ue = c, u = Ne(), c && j && P(j, W), c && C && G(C, W), c = ue, n.markEnd(n.createFunctionDeclaration(e, t, [], u), re);
        }
        function It() {
          var e, t = null, u, l, C, x, j = [], W, ue, re;
          return re = i, Z("function"), _("(") || (e = i, t = ye(), c ? J(e.value) && G(e, a.StrictFunctionName) : J(e.value) ? (l = e, C = a.StrictFunctionName) : Y(e.value) && (l = e, C = a.StrictReservedWord)), x = qe(l), j = x.params, u = x.stricted, l = x.firstRestricted, x.message && (C = x.message), ue = c, W = Ne(), c && l && P(l, C), c && u && G(u, C), c = ue, n.markEnd(n.createFunctionExpression(t, j, [], W), re);
        }
        function Se() {
          if (i.type === y.Keyword)
            switch (i.value) {
        ...
        function _t() {
          var e, t;
          return A(), _e(), t = i, c = !1, e = wt(), n.markEnd(n.createProgram(e), t);
        }
        function We() {
          var e, t, u, l = [];
...
function Rt(ce, ke) {
  const T = JSON.parse(ke.body), L = Lt.query(T, ke.filter);
