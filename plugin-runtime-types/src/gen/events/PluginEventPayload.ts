...
export type PluginEventPayload = { "type": "ping_request" } & PluginPingRequest | { "type": "ping_response" } & PluginPingResponse | { "type": "boot_request" } & PluginBootRequest | { "type": "boot_response" } & PluginBootResponse | { "type": "import_request" } & PluginImportRequest | { "type": "import_response" } & PluginImportResponse;
