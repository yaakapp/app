...
export const yaakDark: YaakTheme = {
  id: 'yaak-dark',
  name: 'Yaak',
  surface: new YaakColor('hsl(244,23%,13%)', 'dark'),
  border: new YaakColor('hsl(244,23%,23%)', 'dark'),
  surfaceHighlight: new YaakColor('hsl(244,23%,20%)', 'dark'),
  text: new YaakColor('hsl(245,23%,86%)', 'dark'),
  textSubtle: new YaakColor('hsl(245,20%,65%)', 'dark'),
  textSubtlest: new YaakColor('hsl(245,18%,50%)', 'dark'),
